# React + hooks-context/use-effect
...
![useEffect](https://github.com/netology-code/ra16-homeworks/raw/ra-51/hooks-context/use-effect/assets/use-effect.png)

При первой загрузке ни один из элементов не выбран, поэтому отображается только список:

![First load](https://github.com/netology-code/ra16-homeworks/raw/ra-51/hooks-context/use-effect/assets/first-load.png)
